...
public class AES_Demo extends javax.swing.JFrame {
      ...
      fos.close();
       ...
       Random rand = new Random(); 
        ...
        System.out.println("Random Integers: "+rand_int);
         ...
         //f = new File("google.jpg"); //image file path
          f = new File(rand_int+".jpg");
    ...
    //write image
      f = new File("C:\\Users\\admin\\Desktop\\encrypted_image\\encrypted_image.jpg");  //output file path
      ...
      t=Math.round((AES.t2-AES.t1)/(1000000));
      jTextField2.setText(String.valueOf(t)+"ms");
      inputFile=new File(jFileChooser2.getSelectedFile()+"/decrypted_image.jpg");
      fos = new FileOutputStream(inputFile);
      fos.write(b1);
      fos.flush();
      fos.close(); } }
